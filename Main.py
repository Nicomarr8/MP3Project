...
# Search bar and search button
    ...
    def buttonListbox(self):
     ...
     self.btnAddToListbox =  tkinter.Button(self.frames["down"], text = "Add",bg="SystemButtonFace", activebackground="Black", fg="Black",command = self.select_song).grid(row=1, column=4)
